...
//        MethodChannel(binaryMessenger, "com.krishlabs/background_service").apply {
...
//        }
        ...
        MethodChannel(binaryMessenger, "com.krishlabs/app_retain").apply {
            setMethodCallHandler { method, result ->
